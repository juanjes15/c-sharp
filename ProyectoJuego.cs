string codigo, fechaNacString, nick, decision;
...
do
{
    ...
    if (decision == "Si" || decision == "Sí" || decision == "SI" || decision == "si" || decision == "sí" || decision == "SÍ")
    {
        do
        {
...
if (edad <= 20)
{
    if (decision == "no" || decision == "No" || decision == "NO" || decision == "nO")
    {
        Console.WriteLine("Usted queda en el mundo 1");
    }
    else if (decision == "Si" || decision== "Sí" || decision == "SI" || decision == "si" || decision == "sí" || decision == "SÍ")
    {
        if (nivel1 < 50)
        {
